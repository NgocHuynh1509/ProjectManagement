...
router.get('/profile', exports.getMyProfile);
router.put('/profile', exports.updateMyProfile);
router.get('/attendance', exports.getMyAttendance);
router.get('/tasks', exports.getMyTasks);
router.get('/tasks/:taskId', exports.getMyTaskById);
router.put('/tasks/:taskId/status', exports.updateMyTaskStatus);
router.post('/tasks/:taskId/comments', exports.addTaskComment);
router.get('/projects', exports.getMyProjects);
router.get('/projects/:projectId', exports.getMyProjectById);
router.get('/leave', exports.getMyLeaveRequests);
router.post('/leave', exports.createLeaveRequest);
router.delete('/leave/:id', exports.cancelLeaveRequest);
